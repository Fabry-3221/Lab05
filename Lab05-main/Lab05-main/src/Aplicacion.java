...
public class Aplicacion {
    ...
    public static void main(String[] args) {
        ...
        if (userSelection == JFileChooser.APPROVE_OPTION) {
            ...
            String genero = seleccionarFiltro("Genero");
            String edad = seleccionarFiltro("Edad");
            String condicion = seleccionarFiltro("Condicion Medica");
            ...
            System.out.println("Desea visualizar los datos en un grafico? (S/N): ");
            String respuestaGrafico = scanner.nextLine();
            if (respuestaGrafico.equalsIgnoreCase("S")) {
                System.out.println("Seleccione el tipo de grafico (1 - Barras, 2 - Pastel): ");
    ...
    private static List<Map<String, String>> filtrarDatos(String ciudad, String genero, String edad, String condicion) {
        return data.stream()
                ...
                .filter(row -> genero.equals("Todos") || genero.equals(row.get("Genero")))
                .filter(row -> edad.equals("Todos") || edad.equals(row.get("Edad")))
                .filter(row -> condicion.equals("Todos") || condicion.equals(row.get("Condicion Medica")))
    ...
    private static void generarGrafico(Map<String, Long> datos, int tipoGrafico) {
        if (tipoGrafico == 1) {
            ...
            System.out.println("Tipo de gráfico no valido.");
        }
    }
    ...
    private static void mostrarGrafico(JFreeChart chart) {
        ApplicationFrame frame = new ApplicationFrame("Visualizacion de Datos");
